...
import com.shenque.model.ServiceResult;
...
public class DeleteGoods {
    ...
    private static final Logger logger = Logger.getLogger(DeleteGoods.class);
     ...
     * @return
     */
    @ApiOperation(value="删除淘宝天猫商品", notes="删除淘宝天猫商品")
    @DeleteMapping("/tb/id/{id}")
    public String deleteTb(@PathVariable String id) {
        boolean flag = false;
        try {
            flag = eSUtil.deleteDucId(taobao_index_alias_Name, taobao_type, id);
            return new ReResult(flag).toString();
        } catch (Exception e) {
            e.printStackTrace();
            return new ReResult(ApiResponse.Status.INTERNAL_SERVER_ERROR.getCode(),"删除淘宝天猫商品异常" + e ,flag).toString();
        }
    }
     ...
     * @return
     */
    @ApiOperation(value="删除拼多多商品", notes="删除拼多多商品")
    @DeleteMapping("/pindd/id/{id}")
    public String deletePindd(@PathVariable  String id) {
        boolean flag = false;
        try {
            flag = eSUtil.deleteDucId(pindd_index_alias_Name, pindd_type, id);
            return new ReResult(flag).toString();
        } catch (Exception e) {
            e.printStackTrace();
            return new ReResult(ApiResponse.Status.INTERNAL_SERVER_ERROR.getCode(),"删除拼多多商品异常" + e ,flag).toString();
        }
    }
     ...
     * @return
     */
    @ApiOperation(value="删除抖货商品", notes="删除抖货商品")
    @DeleteMapping("/dou/id/{id}")
    public String deleteDou(@PathVariable  String id) {
        boolean flag = false;
        try {
            flag =  eSUtil.deleteDucId(dou_index_alias_Name, dou_type, id);
            return new ReResult(flag).toString();
        } catch (Exception e) {
            e.printStackTrace();
            return new ReResult(ApiResponse.Status.INTERNAL_SERVER_ERROR.getCode(),"删除抖货商品异常" + e ,flag).toString();
        }
    }
     ...
     * @return
     */
    @ApiOperation(value="删除京东商品", notes="删除京东商品")
    @DeleteMapping("/jd/id/{id}")
    public String deleteJd(@PathVariable  String id) {
        boolean flag = false;
        try {
            flag =  eSUtil.deleteDucId(jd_index_alias_Name, jd_type, id);
            return new ReResult(flag).toString();
        } catch (Exception e) {
            e.printStackTrace();
            return new ReResult(ApiResponse.Status.INTERNAL_SERVER_ERROR.getCode(),"删除京东商品异常" + e ,flag).toString();
        }
    }
}
